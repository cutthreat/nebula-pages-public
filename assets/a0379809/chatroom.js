(() => {
  ...
  const sendLocal = () => {
    ...
    root.dispatchEvent(new CustomEvent('nebula:chat-message-created-local', { bubbles: true, detail: { conversationId: conversation.id, messageId: message.id, text: message.text || '', media: message.media || null, deliveryState: 'sending', localOnly: true, persisted: false, delivered: false, serverReceipt: false } }));
