(() => {
  ...
  support.addEventListener('click', () => {
    if (support.hasAttribute('href')) return;
    request(support, 'support', 'nebula:payment-support-requested', 'Payment support was requested from the host. No support destination or payment change was claimed.');
  });
