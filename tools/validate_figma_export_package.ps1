...
$required = @(
  ...
  "data\figma-publishables.local.json",
  "data\figma-publishables.local.csv",
  "data\figma-components-map.json",
  "data\figma-components-map.csv",
  "data\figma-verstka-readiness.json",
  "data\figma-publishable-map.json",
  "data\figma-publishable-map.csv",
